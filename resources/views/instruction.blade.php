...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="text-center pb-2">
            <p class="section-title px-5"><span class="px-2">INSTRUCTIONS AUX AUTEURS</span></p>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="text-wrap p-lg-6" align="justify">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:center"><img alt="" src="{{ asset('front/img/head.png') }}" style="height:84px; width:650px" class="col-12"></td>
                                </tr>
                            </tbody>
                            </table>
