...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0 text-center">
                ...
                <a href="{{ route('instr') }}" class="nav-item nav-link">Instructions aux auteurs</a>
 ...
 <div class="p-5"></div>
 <!-- Footer Start -->
 <div class="container-fluid bg-dark text-light footer fixed-bottom wow fadeIn" data-wow-delay="0.1s">
    <div class="container">
        <div class="copyright">
