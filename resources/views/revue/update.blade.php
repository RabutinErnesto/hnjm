        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3 needs-validation" action="{{route('revue.update', $revue)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <select name="autreAuteur[]" id="autre-auteur" id="multiple" class="form-control select2" multiple>
                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group has-validation">
                      <input type="file" name="fichier" class="form-control"  src="{{ URL::asset('back/fichier'.$item->fichier) }}"  >
